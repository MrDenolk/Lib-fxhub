	...
	Themes = {
		Main = {
			...
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(75, 0, 130)),  -- roxo
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(138, 43, 226)) -- roxo claro
			}),
			["Color Hub 2"] = Color3.fromRGB(15, 15, 20),
			["Color Stroke"] = Color3.fromRGB(138, 43, 226),
			["Color Theme"] = Color3.fromRGB(75, 0, 130),
